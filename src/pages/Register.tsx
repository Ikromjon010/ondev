...
import { GraduationCap, Github, Eye, EyeOff } from "lucide-react";
...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const email = phone.replace(/\s/g, "").replace("+", "") + "@ondev.uz";
    ...
    if (error) {
      ...
      toast.success("Hisob yaratildi! Tizimga kirilmoqda...");
      navigate("/dashboard");
    }
  };
